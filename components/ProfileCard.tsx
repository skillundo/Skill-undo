    ...
    >
      ...
      <div className="mt-auto pt-4 flex items-center justify-end border-t border-white/5">
        <Link 
          ...
          className="group/btn flex items-center gap-2 text-sm font-semibold text-white bg-white/5 hover:bg-neon-cyan border border-white/10 hover:border-neon-cyan hover:text-black px-4 py-2 rounded-full transition-all duration-300"
        >
          View Profile
